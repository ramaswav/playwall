...
(function ($) {
    ...
    attach: function (context) {
      $(function() {
        ...
        $(".dialogify").on("click", function(e) {
          ...
          item_url=$(this).attr("data-content-url");
  ...
  Drupal.playwall.getContent = function(item_id, url, brand) {
    $.ajax({
      url: 'hackday/ajax',
