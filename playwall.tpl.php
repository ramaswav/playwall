...
<head>
  ...
  <!-- <link href="css/demoengine.min.css" rel="stylesheet"> -->
  <!-- <script src="js/demoengine.min.js"></script> -->
    ...
    <article class="node clearfix" style="margin-top: 30px;">
        ...
        <div class="field field-name-field-migrate-example-image field-type-image field-label-hidden">
          <div class="field-items">
            <div class="field-item even">
              <img typeof="foaf:Image" src="<?php echo $article->image->thumbnail;?>" alt="<?php echo $article->headline;?>">
            </div>
          </div>
        </div>
      ...
      <footer>
        <ul class="links inline">
          ...
          <li class="node-readmore first dialogify">
            <a href='javascript:void(0);' data-image-url='http://www.dunckelvet.com/clients/2144/images/Cat_pictures2.jpg' class="dialogify">fcuck</a>
          </li>
        </ul>
      </footer>
...
<script>
  ...
  $(function() {
    ...
    $(".dialogify").on("click", function(e) {
      e.preventDefault();
      url=$(this).attr("data-image-url").toString();
